...
/***/ "./node_modules/selectivity/apis/react.js":
/*!************************************************!*\
  !*** ./node_modules/selectivity/apis/react.js ***!
  \************************************************/
...
Selectivity.inherits(SelectivityReact, React.Component, {
  ...
  componentDidMount: function () {
    ...
    if (!props.onChange && (props.data || props.value) && !props.readOnly) {
      throw new Error('Selectivity: You have specified a data or value property without an ' + 'onChange listener. You should use defaultData or defaultValue ' + 'instead.');
    }
    if (props.autoFocus) {
      this.focus();
    }
